...
// WithName adds the name to the circuits circuit types read params
func (o *CircuitsCircuitTypesReadParams) WithName(name *string) *CircuitsCircuitTypesReadParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the circuits circuit types read params
func (o *CircuitsCircuitTypesReadParams) SetName(name *string) {
	o.Name = name
}

// WithSlug adds the slug to the circuits circuit types read params
func (o *CircuitsCircuitTypesReadParams) WithSlug(slug *string) *CircuitsCircuitTypesReadParams {
	o.SetSlug(slug)
	return o
}

// SetSlug adds the slug to the circuits circuit types read params
func (o *CircuitsCircuitTypesReadParams) SetSlug(slug *string) {
	o.Slug = slug
}
