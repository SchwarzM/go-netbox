...
// WithName adds the name to the ipam roles read params
func (o *IPAMRolesReadParams) WithName(name *string) *IPAMRolesReadParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the ipam roles read params
func (o *IPAMRolesReadParams) SetName(name *string) {
	o.Name = name
}

// WithSlug adds the slug to the ipam roles read params
func (o *IPAMRolesReadParams) WithSlug(slug *string) *IPAMRolesReadParams {
	o.SetSlug(slug)
	return o
}

// SetSlug adds the slug to the ipam roles read params
func (o *IPAMRolesReadParams) SetSlug(slug *string) {
	o.Slug = slug
}
