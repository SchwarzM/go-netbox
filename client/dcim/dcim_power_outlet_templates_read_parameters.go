...
// WithDevicetypeID adds the devicetypeID to the dcim power outlet templates read params
func (o *DcimPowerOutletTemplatesReadParams) WithDevicetypeID(devicetypeID *string) *DcimPowerOutletTemplatesReadParams {
	o.SetDevicetypeID(devicetypeID)
	return o
}

// SetDevicetypeID adds the devicetypeId to the dcim power outlet templates read params
func (o *DcimPowerOutletTemplatesReadParams) SetDevicetypeID(devicetypeID *string) {
...
// WithName adds the name to the dcim power outlet templates read params
func (o *DcimPowerOutletTemplatesReadParams) WithName(name *string) *DcimPowerOutletTemplatesReadParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the dcim power outlet templates read params
func (o *DcimPowerOutletTemplatesReadParams) SetName(name *string) {
	o.Name = name
}
