...
// WithName adds the name to the dcim platforms read params
func (o *DcimPlatformsReadParams) WithName(name *string) *DcimPlatformsReadParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the dcim platforms read params
func (o *DcimPlatformsReadParams) SetName(name *string) {
	o.Name = name
}

// WithSlug adds the slug to the dcim platforms read params
func (o *DcimPlatformsReadParams) WithSlug(slug *string) *DcimPlatformsReadParams {
	o.SetSlug(slug)
	return o
}

// SetSlug adds the slug to the dcim platforms read params
func (o *DcimPlatformsReadParams) SetSlug(slug *string) {
	o.Slug = slug
}
