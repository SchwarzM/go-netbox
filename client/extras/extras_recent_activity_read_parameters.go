...
// WithUser adds the user to the extras recent activity read params
func (o *ExtrasRecentActivityReadParams) WithUser(user *string) *ExtrasRecentActivityReadParams {
	o.SetUser(user)
	return o
}

// SetUser adds the user to the extras recent activity read params
func (o *ExtrasRecentActivityReadParams) SetUser(user *string) {
	o.User = user
}

// WithUsername adds the username to the extras recent activity read params
func (o *ExtrasRecentActivityReadParams) WithUsername(username *string) *ExtrasRecentActivityReadParams {
	o.SetUsername(username)
	return o
}

// SetUsername adds the username to the extras recent activity read params
func (o *ExtrasRecentActivityReadParams) SetUsername(username *string) {
	o.Username = username
}
